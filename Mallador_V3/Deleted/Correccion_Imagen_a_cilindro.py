...
def Corrector_Imagen_cilindro(img1, Position_Matrix):
    ...
    Lim_Pix_I, Lim_Pix_1_L,Lim_Pix_1_R,Lim_Pix_2_L,Lim_Pix_2_R,Lim_Pix_3_L,Lim_Pix_3_R,Lim_Pix_F,Matr_Div_1,Matr_Div_2,Matr_Div_3,Matr_Div_4=recorte_imagen(img1,Position_Matrix )
