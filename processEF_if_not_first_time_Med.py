...
def processEF_if_not_first_time(coladas, pregunta1, CLE,tasaDesgaste, t,Historia):
    ...
    TasasDesgaste=np.zeros(int(np.shape(Historia)[1]/(NNod+3)))
    ...
    temp = [] 
    Historia2=np.zeros((1,NNod+3))
    for colada in range (coladas_en_historia,coladas):    
...
#Carga----------------------------------------------------------------------------------------------------------------------------------------------   
        ...
        Historia2 = Creador_Historia(Historia2,NNod,colada,Long1,TFinal,tasaDesgaste)
...
#Descarga----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Historia2=np.delete(Historia2, (0), axis=0)
    Historia2=Historia2.tolist()
