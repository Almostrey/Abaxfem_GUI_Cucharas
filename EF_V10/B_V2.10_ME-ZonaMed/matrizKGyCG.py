    ...
    for i in range (NElemTotal):                                                                                                                # Bucle para la matriz de conductividad y masa de cada elemento finito
        if 0 * NElemTotal / NMateriales <= i < 1 * NElemTotal / NMateriales:                                                                    # Matrices del material Sindoform
            if i == 0 * NElemTotal / NMateriales:
                ke = np.array (([1,-1],[-1,1])) *(( 8.92857*(10**(-10))*(TInicial [i][0])**2 - 6.89464*(10**(-4))*TInicial[i][0] + 3.30171+ 
                                                8.92857*(10**(-10))*(TInicial [i+1][0])**2 - 6.89464*(10**(-4))*TInicial[i+1][0] + 3.30171) / 2) / dx1      # Matriz de conductividad     # Matriz de conductividad
                ...
                ke = np.array (([1,-1],[-1,1])) *(( 8.92857*(10**(-10))*(TInicial [i][0])**2 - 6.89464*(10**(-4))*TInicial[i][0] + 3.30171+ 
                                                8.92857*(10**(-10))*(TInicial [i+1][0])**2 - 6.89464*(10**(-4))*TInicial[i+1][0] + 3.30171) / 2) / dx1
