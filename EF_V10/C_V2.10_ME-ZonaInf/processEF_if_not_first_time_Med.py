...
from Proceso_Elementos_Finitos_Med import Proceso_Elementos_Finitos
def processEF_if_not_first_time(coladas, pregunta1, CLE,tasaDesgaste, t,Historia):
    ...
    TInicial[:,0]=Historia[-1,2:-1]                                                                                        
                                                                                                             ########LLAMAR historia DIEGO 
    coladas_en_historia=len(Historia)   
    col = []                                                                                                                   # Vector donde se almacenan las coladas
    temp = [] 
    
    for colada in range (coladas_en_historia,coladas):                                                                                                     # Bucle para iterar las coladas        
        if colada == coladas_en_historia:                                                                                                                # Inicializado de espesores solo en la primera colada
            Long1 = [Historia[-1,1]-Historia[-1,-1] , 15. , 108. , 10. , 40.]                                                                                         # Vector de espesores de materiales     
