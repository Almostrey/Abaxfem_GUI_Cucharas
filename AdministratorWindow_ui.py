...
class Ui_AdministratorWindow(object):
    def setupUi(self, AdministratorWindow):
        ...
        AdministratorWindow.setMinimumSize(QSize(1200, 0))
        icon = QIcon()
...
"}")
        ...
        self.frame.setMinimumSize(QSize(98, 0))
...
"                                 stop: 0.5 #D8D8D8, stop: 1.0 #D3D3D3);")
        ...
        sizePolicy1.setHeightForWidth(self.treeMenu.sizePolicy().hasHeightForWidth())
        self.treeMenu.setSizePolicy(sizePolicy1)
...
"background-color:rgba(255, 255, 255, 0);")
        ...
        sizePolicy2.setHeightForWidth(self.pbAddCuchara.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.labelColadas.sizePolicy().hasHeightForWidth())
