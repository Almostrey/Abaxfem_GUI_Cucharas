...
def EF_sup(coladas_DADA_DIEGO, temp_medidas, pregunta2:bool, path, t):
#_Informacion inicial--------------------------------------------------------------------------------------------------------------------------------------------------------------------------    
    ...
    #Aproximacion1---------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            #with QThreadPool.pool (processes=nlineas) as pool:
...
def getRiesgo(cantColadas, coladas, tempZonasTodasF, tempZonasTodasT, Nuevo1Viejo2, path):
    RiesgoF = []
    RiesgoT = []
    observacionF = []
    observacionT = []
    ...
    if Nuevo1Viejo2 == 1:
        # Frontal
        [Riesgo, numObs] = EF_sup(cantColadas, np.column_stack((coladas,tempZonasTodasF[0])), haveHistory(cantColadas, path+"HistoriaSupF.xlsx"), path+"HistoriaSupF.xlsx", t)
        RiesgoF.append(Riesgo)
        numObservacionesF.append(numObs)
        observacionF.append(returnObs(numObs))
        [Riesgo, numObs] = main_MP_Med.EF_med(cantColadas, np.column_stack((coladas,tempZonasTodasF[1])), haveHistory(cantColadas, path+"HistoriaMedF.xlsx"), path+"HistoriaMedF.xlsx", t)
        RiesgoF.append(Riesgo)
        numObservacionesF.append(numObs)
        observacionF.append(returnObs(numObs))
        [Riesgo, numObs] = main_MP_Inf.EF_inf(cantColadas, np.column_stack((coladas,tempZonasTodasF[2])), haveHistory(cantColadas, path+"HistoriaInfF.xlsx"), path+"HistoriaInfF.xlsx", t)
        RiesgoF.append(Riesgo)
        numObservacionesF.append(numObs)
        observacionF.append(returnObs(numObs))
        #### Trasera
        [Riesgo, numObs] = EF_sup(cantColadas, np.column_stack((coladas,tempZonasTodasT[0])), haveHistory(cantColadas, path+"HistoriaSupT.xlsx"), path+"HistoriaSupT.xlsx", t)
        RiesgoT.append(Riesgo)
        numObservacionesT.append(numObs)
        observacionT.append(returnObs(numObs))
        [Riesgo, numObs] = main_MP_Med.EF_med(cantColadas, np.column_stack((coladas,tempZonasTodasT[1])), haveHistory(cantColadas, path+"HistoriaMedT.xlsx"), path+"HistoriaMedT.xlsx", t)
        RiesgoT.append(Riesgo)
        numObservacionesT.append(numObs)
        observacionT.append(returnObs(numObs))
        [Riesgo, numObs] = main_MP_Inf.EF_inf(cantColadas, np.column_stack((coladas,tempZonasTodasT[2])), haveHistory(cantColadas, path+"HistoriaInfT.xlsx"), path+"HistoriaInfT.xlsx", t)
        RiesgoT.append(Riesgo)
        numObservacionesT.append(numObs)
        observacionT.append(returnObs(numObs))
    elif Nuevo1Viejo2 == 2:
